...
def plot_results(hyperparameters,):
    # global figure
    fig_para, ax_para = plt.subplots(nrows=len(hyperparameters), ncols=2, figsize=(8,
                                                                len(
                                                                    hyperparameters)*3), sharey=True)
    ...
    fig_para.subplots_adjust(top=0.92, bottom=0.06)
    fig_para.savefig(f'../../Plots/MAE_{hyperparameter}.pdf', format="pdf")
    fig_para.savefig(f'../../Plots/MAE_{hyperparameter}.png', format="png", dpi=300)



if __name__ == '__main__':
    plot_results(['ensemble_size',
                                              'iterations',
                                              'elevation_step',
                                              ])
