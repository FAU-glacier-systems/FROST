...
def initialize(params, state):
    ...
    params.thr_temp_snow = oggm_mb_calib["smb_oggm_TI_temp_all_solid"]
    params.thr_temp_rain = oggm_mb_calib["smb_oggm_TI_temp_all_liquid"]
    params.temp_melt = oggm_mb_calib["smb_oggm_TI_temp_melt"]
    params.melt_f = oggm_mb_calib["smb_oggm_TI_melt_f"]  # unit: mm water / (celcius day)
