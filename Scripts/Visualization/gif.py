...
dir = ('../../Experiments/RGI2000-v7.0-G-11-01182/geometry_update'
       '/Experiment_50_50_1.0_1/')
...
frame_one = Image.open(dir + 'status_1_2005.png')

frame_one.save("../../Plots/IterationAllalin.gif", format="GIF",
